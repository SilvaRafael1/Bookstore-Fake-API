...
function CreateBook() {
    ...
    const validationSchema = Yup.object().shape({
        ...
        title: Yup.string().required("Você deve inserir um titulo"),
        description: Yup.string().required("Você deve inserir uma descrição"),
        pageCount: Yup.number().positive("Número deve ser positivo").required("Você deve inserir a quantidade de páginas").integer(),
        excerpt: Yup.string().required("Você deve inserir um excerto"),
